...
const sortbyname = ref(['Price:High to Low', 'Price:Low to High', 'Popularity', 'Fresh Arrivals']);
...
<template>
    ...
    <v-col lg="6" sm="6" cols="12">
      <div class="d-flex gap-2 align-center">
        <v-text-field
          ...
          persistent-placeholder placeholder="Search Product"
          hide-details
          density="compact"
          color="primary"
        ></v-text-field>
  ...
  <v-navigation-drawer temporary location="right" v-model="sDrawer" width="300" top v-if="!lgAndUp">
