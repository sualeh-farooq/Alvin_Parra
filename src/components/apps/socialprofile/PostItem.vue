...
const items = ref([{ title: 'Edit' }, { title: 'Delete' }]);
...
<template>
  <v-card variant="outlined" elevation="0" class="withbg pa-5">
    ...
    <div class="my-4 mt-5 d-flex gap-3">
      <v-btn
    ...
    <!---Comment Form-->
    <div class="d-block d-sm-flex gap-3 align-center mb-5" v-if="showCommentBox">
