const AuthRoutes = {
  ...
  children: [
    ...
    },
    {
      name: 'Login 3',
      path: '/auth/login3',
      component: () => import('@/views/authentication/auth3/Login3.vue')
    },
    {
      name: 'Register 3',
      path: '/auth/register3',
      component: () => import('@/views/authentication/auth3/Register3.vue')
    },
    {
    ...
    },
    {
      name: 'Login 2',
      path: '/auth/login2',
      component: () => import('@/views/authentication/auth2/Login2.vue')
    },
    {
      name: 'Register 2',
      path: '/auth/register2',
      component: () => import('@/views/authentication/auth2/Register2.vue')
    },
    {
