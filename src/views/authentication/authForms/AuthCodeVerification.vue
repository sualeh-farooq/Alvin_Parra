...
<template>
  ...
  <v-form ref="logform" lazy-validation v-model="valid" class="mt-7 loginForm">
    <v-row class="mb-4">
      <v-col cols="3">
        <v-text-field variant="outlined" density="comfortable" hide-details="auto" color="primary"></v-text-field>
      </v-col>
      <v-col cols="3">
        <v-text-field variant="outlined" density="comfortable" hide-details="auto" color="primary"></v-text-field>
      </v-col>
  ...
  <div class="d-sm-flex align-start justify-space-between my-4">
    ...
    <v-btn variant="plain" color="primary" to="/#" class="text-capitalize mr-n2 mt-2 mt-sm-0">Resend Code</v-btn>
  </div>
  <div class="mt-5 text-right">
    <v-divider />
    <v-btn variant="plain" to="/auth/code-verify" class="mt-2 text-capitalize text-wrap mr-n2"
