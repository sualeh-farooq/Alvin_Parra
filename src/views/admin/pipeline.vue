...
export default {
  data() {
    ...
    const headers = [
      ...
      {text: 'Agent', value: 'type', sortable: true},
      {text: 'Product', value: 'pipeline', sortable: true},
      {text: 'Carrier', value: 'closingDate', sortable: true},
      {text: 'Policy #', value: 'closingDate', sortable: true},
      {text: 'Days Open', value: 'closingDate', sortable: true},

      {text: 'Status', value: 'status', sortable: true},
      {text: 'Stage', value: 'stage', sortable: true},
      {text: 'Service', value: 'estIncome', sortable: true},
      {text: 'Temp', value: 'wrtAgentSplit', sortable: true},
    ...
    <v-col col="12">
      <v-card variant="outlined" elevation="0" class="withbg">
        ...
        <v-card-text>
          <v-row>
            <v-col cols="2">
              <v-select class="" label="Account Type" :items="accTypes" v-model="accTypesVal" color="primary"
            ...
            <v-col cols="2" xl="2">
              <v-select label="Status" :items="statuses" color="primary" variant="outlined"
                        hide-details density="compact"></v-select>
            </v-col>
            <v-col cols="3" xl="2">
              <v-select label="Sort by days open" :items="openDays" color="primary"
                        variant="outlined" hide-details density="compact"></v-select>
            </v-col>
            <v-col cols="3" xl="2">
            ...
            <v-col cols="3" xl="2">
              <v-select label="Select Agent" :items="agents" color="primary" variant="outlined" hide-details
                        density="compact" v-model="defaultAgent"></v-select>
            </v-col>
            <v-col cols="3" xl="2">
            ...
            <v-col v-if="tab2 === '22' ">
              <!--              <v-select class="mt-2" label="Sort by follow up and est closing Date" :items="closingDate"-->
              <!--                        color="primary" variant="outlined" hide-details density="compact"></v-select>-->
