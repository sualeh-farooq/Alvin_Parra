                ...
                <v-card-text>
                    <Form>
                        ...
                        <v-row>
                            ...
                            <v-col cols="12" md="6">
                                <v-autocomplete label="Select Pipeline" :items="Pipelines" color="primary"
                                    variant="outlined" hide-details></v-autocomplete>
                                <v-btn class="mt-3" color="primary">Create Opportunity Name
                                    <CircleArrowDownIcon class="mx-1" />
                                </v-btn>


                            </v-col>
                            <v-col cols="12" md="6">
                                <div @click="showDatePicker = true" v-if="!showDatePicker">
