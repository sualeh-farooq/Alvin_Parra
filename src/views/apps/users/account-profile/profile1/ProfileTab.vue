    ...
    <v-col cols="12" lg="8">
      <v-card variant="flat">
        <v-card variant="outlined">
          ...
          <v-card-text>
            ...
            <v-row class="py-2" v-for="(detail, i) in details">
      ...
      <v-card variant="flat" class="mt-6">
        <v-card variant="outlined">
          ...
          <v-divider></v-divider>
          <v-card-text>
            <v-row class="py-2" v-for="(edu, i) in edus">
              <v-col md="4">
        ...
        <v-card variant="flat" class="mt-6">
          <v-card variant="outlined">
            ...
            <v-divider></v-divider>
            <v-card-text>
              <v-row class="py-2" v-for="(emp, i) in emps">
                <v-col md="4">
        ...
        <v-card variant="flat" class="mt-6">
          <v-card variant="outlined">
            ...
            <v-card-text>
              <v-row class="py-2">
                <v-col cols="12" md="6" v-for="(skill, i) in skills">
                  <h5 class="text-subtitle-1 font-weight-regular">{{ skill.title }}</h5>
                  <div class="d-flex align-center">
                    <v-progress-linear :model-value="skill.value" :color="skill.color"> </v-progress-linear>
