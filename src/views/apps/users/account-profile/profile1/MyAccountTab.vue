...
const textLanguage = ref(['Washington']);
const textSigning = ref(['Starterup']);

const secure = ref(false);
const login = ref(false);
const approve = ref(true);

const recognizes = ref([
      ...
      <v-card variant="flat">
        <v-card variant="outlined">
          ...
          <v-card-text>
            ...
            <v-switch color="primary" v-model="secure" class="wrap-label">
            ...
            <v-switch color="primary" v-model="login" class="wrap-label">
              <template v-slot:label>
            ...
            <v-switch color="primary" v-model="approve" class="wrap-label">
              <template v-slot:label>
            ...
            <v-list>
              <v-list-item v-for="(recognize, i) in recognizes" :key="i" active-color="primary" class="px-0">
            ...
            <v-list>
              <v-list-item v-for="(activeSession, i) in activeSessions" :key="i" active-color="primary" class="px-0">
                <template v-slot:prepend>
