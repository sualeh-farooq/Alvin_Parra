  ...
  <v-row>
    <v-col cols="12">
      <UiParentCard title="Create Invoice">
        <v-row>
          <v-col cols="12" lg="4">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2">Invoice Number *</v-label>
            <v-text-field
              type="text"
              color="primary"
              v-model="textinvoice"
              hide-details
              variant="outlined"
              persistent-placeholder placeholder="Invoice #"
            ></v-text-field>
          </v-col>
        </v-row>
        ...
        <v-row>
          <v-col cols="12" lg="4">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2">Customer Name *</v-label>
            <v-text-field
              type="text"
              color="primary"
              ...
              hide-details
              variant="outlined"
              persistent-placeholder placeholder="Alex Z."
            ></v-text-field>
          </v-col>
          <v-col cols="12" lg="4">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2">Customer Email *</v-label>
            <v-text-field
              type="email"
              color="primary"
              ...
              hide-details
              variant="outlined"
              persistent-placeholder placeholder="alex@company.com"
            ></v-text-field>
          </v-col>
          <v-col cols="12" lg="4">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2">Customer Contact Numer *</v-label>
            <v-text-field
              type="text"
              color="primary"
              ...
              hide-details
              variant="outlined"
              persistent-placeholder placeholder="+00 0000 0000"
            ></v-text-field>
          </v-col>
          <v-col cols="12">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2">Customer Address *</v-label>
            <v-text-field
              type="text"
              color="primary"
              ...
              hide-details
              variant="outlined"
              persistent-placeholder placeholder="Enter Address"
            ></v-text-field>
          </v-col>
        </v-row>
        <v-divider class="my-6"></v-divider>
        <v-row>
          <v-col cols="12" lg="6">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2">Invoice Date *</v-label>
            <v-text-field
              type="text"
              color="primary"
              v-model="textdate"
          ...
          <v-col cols="12" lg="6">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2">Status *</v-label>
        ...
        <v-row>
          <v-col cols="12">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2">Terms and Condition: *</v-label>
            <v-text-field
              type="text"
              color="primary"
              v-model="textterms"
