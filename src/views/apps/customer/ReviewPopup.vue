...
<template>
  <v-dialog v-model="dialogs.dialog" max-width="400">
    <v-card>
      <v-card-text>
      ...
      <v-card-actions>
        <v-btn color="primary" variant="flat" @click="dialogs.dialog = false">Create</v-btn
        ><v-btn variant="flat" @click="dialogs.dialog = false">Cancel</v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
</template>
