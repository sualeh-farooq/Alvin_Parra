        ...
        <div class="mt-4">
          <perfect-scrollbar v-bind:style="{ height: '270px' }">
            <v-list lines="two" class="py-0">
              <v-list-item v-for="(revenue, i) in revenues" :value="revenue" active-color="secondary" rounded="sm">
                ...
                <div class="d-inline-flex align-start justify-space-between w-100">
                  <div>
