  ...
  <v-row>
    ...
    <v-col cols="12" sm="6" lg="3">
      <v-card class="bg-primary" elevation="0">
        ...
        <apexchart type="area" height="100" :options="chartOptions1" :series="areaChart1.series"> </apexchart>
      </v-card>
    </v-col>
    ...
    <v-col cols="12" sm="6" lg="3">
      <v-card class="bg-success" elevation="0">
        ...
        <apexchart type="area" height="100" :options="chartOptions3" :series="areaChart3.series"> </apexchart>
      </v-card>
    </v-col>
